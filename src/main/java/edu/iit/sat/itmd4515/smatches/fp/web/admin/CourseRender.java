...
import edu.iit.sat.itmd4515.smatches.fp.web.*;
 ...
 * @author smatches
 */
@WebServlet(name = "CourseRender", urlPatterns = {"/courseAdmin","/courseAdmin"})
public class CourseRender extends HttpServlet {

    
     private static final Logger LOG = Logger.getLogger(CourseRender.class.getName());
